...
final class MangaCollectionViewCell: UICollectionViewCell {
    static let cellIdentifier = "MangaCollectionViewCell"
    ...
    public func configure(with viewModel: MangaCollectionViewCellViewModel) {
        titleLabel.text = viewModel.mangaTitle
